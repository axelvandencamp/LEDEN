...
SELECT	
	...
	sq1.email, sq1.telefoonnr, sq1.gsm, sq1.birthday, sq1.leeftijd, sq1.afdeling, 
	COALESCE(p.membership_start,p.create_date::date) aanmaak_datum,
	EXTRACT(YEAR from AGE(p.membership_start)) aantal_jaren_lid,
	sq1.adres_status adres_verkeerd, sq1.nooit_contact, sq1.wenst_geen_post_van_np, sq1.wenst_geen_email_van_np, d.jaareerstegift, d.jaarlaatstegift, d.jarendonateur, d.aantalgiften, d.totaalgiften, d.grootstegift, d.avggiftenperjaar, d.avgbedragperjaar,
	p2.erflater, p2.commerciële_partner, p2.bos_partner, p2.major_donor, p2.schenker_grond, p2.vrijwilliger, p2.bestuurder, p2.conservator, p2.aankoper
...
WHERE 	p.active = 't'	
	...
	--afdeling
	AND COALESCE(COALESCE(a2.id,a.id),0) IN (248524,248549)